...
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            else if (typeof content === 'object' && 'albumMessage' in content && content.albumMessage) {
            	const albumMsg = await Utils_1.prepareAlbumMessageContent(jid, content.albumMessage, {
            		sock: {
            			relayMessage, 
            			waUploadToServer
            		}, 
