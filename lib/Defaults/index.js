...
export const LIBRARY_NAME = 'Bail-Lite';
...
const loadPinnedVersion = () => {
    try {
        const here = dirname(fileURLToPath(import.meta.url));
        const raw = readFileSync(join(here, 'baileys-version.json'), 'utf-8');
       ...
       console.log(err)
       return [2, 3000, 1048212344]
    }
};

export const DEFAULT_CONNECTION_CONFIG = {
    version: loadPinnedVersion(),
